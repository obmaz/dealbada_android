 ...
 */
public class BoardFragment extends BaseFragment implements BoardPagerFragment.PageSelectedListener {
    ...
    public static BoardFragment newInstance(String title, String url) {
        Log.d("moon", "moon BoardFragment newInstance");
